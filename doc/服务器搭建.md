...
2. 赋予conda安装包可执行权限：chmod u+x /home/star/pkgs/conda-4.5.9-Linux-x86_64.sh

3. 安装conda：/home/star/pkgs/conda-4.5.9-Linux-x86_64.sh

4. 安装到/home/star/conda中
...
3. 修改settings.py, 添加允许的ip地址
   ...
   ALLOWED_HOSTS = ['47.109.49.83']

4. 运行项目：python manage.py runserver 0.0.0.0:8000

5. 本地打开浏览器，访问 47.109.49.83:8000
...
3. 创建新模块：python manage.py startapp home
...
6. 注册模型类（注册后，后台才能看到），修改home/admin.py
...
8. 进入 http://47.109.49.83:8000/admin/ 可看到新创建的模型类
